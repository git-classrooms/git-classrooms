...
// @Id				GetJoinedClassroomTeamGitlab
// @Tags			team
// @Accept			json
...
// @Router			/classrooms/joined/{classroomId}/teams/{teamId}/gitlab [get]
func (ctrl *DefaultController) GetJoinedClassroomTeamGitlab(c *fiber.Ctx) error {
	ctx := context.Get(c)
