...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Assignment.UnderlyingDB().Statement.Context,
		qCtx.AssignmentProjects.UnderlyingDB().Statement.Context,
		qCtx.Classroom.UnderlyingDB().Statement.Context,
		qCtx.ClassroomInvitation.UnderlyingDB().Statement.Context,
		qCtx.User.UnderlyingDB().Statement.Context,
		qCtx.UserClassrooms.UnderlyingDB().Statement.Context,
	} {
