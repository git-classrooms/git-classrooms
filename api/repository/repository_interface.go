...
type Repository interface {
	...
	Login(username string, password string) (model.User, error)                                                             //c https://github.com/xanzy/go-gitlab/blob/v0.93.2/gitlab.go#L256
	...
	CreateProjectInvite(projectId int, email string)                           //c https://github.com/xanzy/go-gitlab/blob/v0.93.2/invites.go#L157
